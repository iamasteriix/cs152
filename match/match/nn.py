...
class LeakyReLU(Module):
    r"""applies the rectilinear unit function element-wise
    ...
    Shape:
        - Input: :math:`(*)`, where :math:`*` can be any number of additional dimensions.
        - Output: :math:`(*)` same shape as the input
    """

    def forward(self, x: Matrix, negative_slope) -> Matrix:
        return x.leakyrelu(negative_slope)


class MAELoss():
    r"""Creates a criterion that measures the mean absolute error (MAE) 
    ...
    :math:`x` and :math:`y` are matrices of arbitrary shapes with a total
    ...
    Shape:
        - Input: :math:`(*)`, where :math:`*` can be any number of dimensions
